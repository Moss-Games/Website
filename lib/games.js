...
function loadGame(folderName) {
  ...
  return {
    ...
    screenshots,
    // Present but not ready to announce (e.g. missing real assets) — still
    // has a real folder/slug so its own /games/[slug] page works and
    // generateStaticParams keeps building it, it's just left out of the
    // homepage list. See docs/GAMES.md.
